...
public class SecurityConfig {
	...
	public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
		...
		http.authorizeHttpRequests(authorize -> authorize
			...
			.requestMatchers("/","/images/**","/member/**","/member/list","/member/logout","/member/signup","/member/delete/**","/member/update","/notice/list/**","/notice/view/**","/board/list/**","/board/view/**","/board/contentdownload/**","/auth/refresh").permitAll()
