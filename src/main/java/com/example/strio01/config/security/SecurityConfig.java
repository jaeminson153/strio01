...
public class SecurityConfig {
	...
	public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
		...
		http.authorizeHttpRequests(authorize -> authorize
			...
			.requestMatchers("/","/images/**","/member/**","/member/findPasswd","/member/resetPasswd","/member/signup","/member/logout","/member/findId","/notice/list/**","/notice/view/**","/board/list/**","/board/view/**","/board/contentdownload/**","/auth/refresh").permitAll()
